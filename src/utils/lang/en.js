export default {
  "checkAuth.noToken": "Access denied. No token provided.",
  "checkAuth.invalidUserId": "Invalid user id.",
  "generic.internalServerError": "An internal server error occurred, please try again.",
  "checkAuth.userNotFound": "Could not find verified user with the given token and id. Be sure that the account was verified and activated.",
